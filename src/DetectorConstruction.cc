...
{	
	...
	// CreateCyFi(double length, double radius, double thickness, double angle_in, double angle_out, checkoverlaps)	
	CreateCyFi * CyFi = new CreateCyFi(15*cm, 3.5*cm, 1*mm, 55*deg, 0*deg, false);
